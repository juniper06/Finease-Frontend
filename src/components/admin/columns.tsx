...
import { editUser } from "@/actions/auth/user.action";
import { MoreHorizontal } from "lucide-react";

// Separate RoleCell into its own component
...
// Separate ActionCell into its own component
const ActionCell = ({ user, onDelete }: { user: User; onDelete: (id: string) => Promise<void> }) => {
...
export const usersColumn: ColumnDef<User>[] = [
  ...
  },
  {
    accessorKey: "role",
    header: "Role",
    cell: ({ row }) => <RoleCell user={row.original} />, // Use RoleCell component
  },
  {
    id: "actions",
    accessorKey: "actions",
    ...
    cell: ({ row, table }) => {
      ...
      return <ActionCell user={user} onDelete={onDelete} />; // Use ActionCell component
    },
  },
];
