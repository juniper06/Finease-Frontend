...
import { getAllCustomers } from "@/actions/ceo/graphs.action";
...
export default function TotalCustomer({ startupId }: TotalCustomersProps) {
  ...
  useEffect(() => {
    async function fetchCustomers() {
      if (!user) return;
      try {
        const customers = await getAllCustomers(startupId);
